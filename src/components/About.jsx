...
export default function About({ toggleModal }) {
  return (
    <AnimatedComponent
      animateInView={true}
      variants={fadeIn}
      className="section my-7 px-6 pb-4 pt-[2.1rem] text-left leading-6 lg:px-12 lg:pb-6 lg:pt-[2.6rem] lg:leading-[1.85rem]">
      ...
      <div className="pt-9 lg:pt-10">
        {pledges.map((pledge, index) => (
          <AnimatedComponent tag="div" key={pledge.id} animateInView={true} variants={fadeinY(0.8)}>
            <div
